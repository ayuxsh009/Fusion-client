...
// AIMS / Academic Information routes
...
// Student academic procedure routes
...
// Faculty roll list and legacy helpers
...
export const TA_LIST_URL = `${host}/academic-procedures/api/api/tas/`;
export const FACULTY_LIST_URL = `${host}/academic-procedures/api/api/faculties/`;

export const HOD_PENDING_URL = `${host}/academic-procedures/api/hod/pending/`;
export const HOD_APPROVED_URL = `${host}/academic-procedures/api/hod/approved/`;
...
export const TA_STIPENDS_URL = `${host}/academic-procedures/api/ta/stipends/`;
